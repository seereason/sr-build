{-# LANGUAGE DeriveAnyClass, DeriveLift, DeriveGeneric, OverloadedStrings, TemplateHaskell, UndecidableInstances #-}
...
data ProgramVersion =
  ...
  , _localChanges :: Text
  } deriving (Generic, Read, Show, Eq, Ord, Serialize, Lift)
